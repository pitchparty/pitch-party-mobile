...
import { useShopSubmit } from "@/features/create-account/hooks/useShopSubmit";
...
export default function StepTwo() {
  ...
  const { methods, onSubmit, isSubmitting, shopData } = useShopSubmit();
  ...
  const watchedAmenities = watch("amenities", shopData?.amenities || []);
